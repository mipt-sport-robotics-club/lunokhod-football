...
- **Camera** - видеокамера. Именованный объект, характеризуется площадкой нахождения и расположением на ней. Может использоваться как
- **Videostream camera** - bbb
- **ARUCO detector module** - bbb  
- **Ball detector module** - bbb
